...
public class WatchlistAdapter extends RecyclerView.Adapter<WatchlistAdapter.TVShowViewHolder> {
    ...
    public WatchlistAdapter(List<TVShow> tvShows, WatchListener watchListener) {
    ...
    class TVShowViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindTVShow(TVShow tvShow) {
            ...
            itemContainerTvShowBinding.getRoot().setOnClickListener(view -> watchListener.onTVShowClicked(tvShow));
            itemContainerTvShowBinding.imageDelete.setOnClickListener(view -> watchListener.removeTVShowFromWatchlist(tvShow, getAdapterPosition()));
